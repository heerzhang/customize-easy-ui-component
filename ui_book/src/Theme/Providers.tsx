...
const ColorMode = React.forwardRef(({ colors, children, ...other }: ColorModeProps, ref) => {
  const theme = useTheme();
...
export const LightMode = React.forwardRef(({ children, ...other }: ModeProps, ref) => {
  const theme = useTheme();
  return (
...
export const DarkMode = React.forwardRef(({ children, ...other }: ModeProps, ref) => {
  const theme = useTheme();
  return (
